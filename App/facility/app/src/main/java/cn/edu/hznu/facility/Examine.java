    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    new SweetAlertDialog(Examine.this, SweetAlertDialog.SUCCESS_TYPE)
                            .setTitleText("通知")
        ...
        TextView m2=(TextView)findViewById(R.id.inuse);
        m2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gq2=new Intent(Examine.this,Deal.class);
                startActivity(gq2);
            }
        });
    }
